...
.DESCRIPTION
    ...
    cuentademail|smtp|password|port
    0000|1200     #Horario de turno del operario del operario horainicio|horafin 0000 = 00:00
    cuentamail del operario
...
.PARAMETER time
    Intervalo de tiempo entre las revisiones

.PARAMETER path
    Directorio a inspeccionar

.PARAMETER mailFile
    Archivo con los datos necesarios para enviar el correo del operador 
    

.EXAMPLE
    C:\Unlam\sistemas_operativos\scripts\Ejercicio2.ps1 5000 'c:\unlam\sistemas_operativos' 'c:\unlam\sistemas_operativos\mail.txt'
...
#>
    ...
    $timer.start()
#$mailFile = $mailFile   get-job $timer.stop()
